...
// 输入范围定义（根据数据手册Table 9）
#define ADS8688_RANGE_BIPOLAR_10_24V    0x00  // ±2.5 x VREF (±10.24V for VREF=4.096V)
#define ADS8688_RANGE_BIPOLAR_5_12V     0x01  // ±1.25 x VREF (±5.12V for VREF=4.096V) 
#define ADS8688_RANGE_BIPOLAR_2_56V     0x02  // ±0.625 x VREF (±2.56V for VREF=4.096V)
#define ADS8688_RANGE_0_TO_10_24V       0x05  // 0 to 2.5 x VREF (0-10.24V for VREF=4.096V)
#define ADS8688_RANGE_0_TO_5_12V        0x06  // 0 to 1.25 x VREF (0-5.12V for VREF=4.096V)
